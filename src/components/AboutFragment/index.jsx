...
function AboutFragment({ title, description }) {
    const [toggled, updateToggle] = useState(true);
    return (
        <div className="about-fragment">
            <div className="about-fragment-top">
                <h1 className="about-fragment-top-title">{title}</h1>
                <div
                    onClick={() => updateToggle(!toggled)}
                    className="about-fragment-top-icon"
                >
                    <svg
            ...
            <p
                className={
                    toggled
                        ? 'about-fragment-description-up'
                        : 'about-fragment-description-down'
                }
            >
                {description}
            </p>
